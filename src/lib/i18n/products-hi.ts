...
const hiCopy: Record<string, ProductCopy> = {
  ...
  "srikanth-puja-dhoop-jar": {
    tagline: "स्वर्ण ढक्कन वाले वायु-अवरोधक जार में धीमी जलने वाली धूप स्टिक्स।",
    description:
      "प्राकृतिक राल, सुगंधित काष्ठ और शुद्ध अर्क से निर्मित। प्रीमियम वायु-अवरोधक काँच के जार में सुरक्षित ताकि अंतिम बत्ती तक दिव्य सुगंध बनी रहे।",
    notes: ["चंदन", "गुग्गुल", "लोबान", "मोगरा", "गुलाब", "लैवेंडर"],
    burnTime: "प्रति बत्ती 35–45 मिनट",
  },
  "srikanth-dhoop-pouch": {
    tagline: "२० शुद्ध धूप स्टिक्स के साथ नमी-सुरक्षित ज़िपर पाउच।",
    description:
      "ताज़गी बनाए रखने वाले री-क्लोज़ेबल ज़िपर पाउच में पारंपरिक धूप। पूजा, ध्यान और वातावरण शुद्धि के लिए सर्वोत्तम।",
    notes: ["चंदन", "गुग्गुल", "लोबान", "गुलाब", "मोगरा"],
    burnTime: "प्रति बत्ती 25–30 मिनट",
  },
};
